...
[installation guide](../../../docs/user-guide/installation.md). Ask before
installation or changing PATH. Use Node 24 and follow the guide's npm or pnpm
registry installation path for `@tkstang/exhibit`, or its approved archive/source
alternatives. Install only an approved published version or approved archive or
checkout/revision. Do not use `sudo` or automatically clone or fetch a checkout.
Recheck version and help from the original
