...
for (const path of ['../dist/index.d.ts', '../assets/viewer.css', '../assets/viewer.js', '../assets/staticrypt-license.txt']) await access(new URL(path, import.meta.url));
const result = spawnSync(process.execPath, ['dist/cli.js', '--version', '--json'], { encoding: 'utf8' });
