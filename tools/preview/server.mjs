...
import { plaintextHtml, protectHtml } from '../../dist/render/viewer.js';
...
const pages = {
  '/plaintext.html': await plaintextHtml(rendered.html, config),
...
const server = createServer((req, res) => {
  ...
  if (!page) {
    res.writeHead(404);
    res.end('Open /plaintext.html or /protected.html');
    return;
  }
  res.writeHead(200, {
    ...SECURITY_HEADERS,
